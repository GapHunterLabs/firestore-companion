package dev.gaphunter.firestorecompanion.review
 ...
 * number of successful Firestore connections -- never on install,
 * never on a timer, and never for a failed auth attempt. Counts
...
object ReviewPrompt {
    ...
    /** How many successful connections before the prompt shows once. */
    private const val HITS_BEFORE_PROMPT = 5

    private const val KEY_HIT_COUNT = "dev.gaphunter.firestorecompanion.review.hitCount"
    private const val KEY_ANSWERED = "dev.gaphunter.firestorecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Firestore Companion"

    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33330-firestore-companion/reviews"

    /**
     * Call this once per real, successful Firestore connection. Safe
